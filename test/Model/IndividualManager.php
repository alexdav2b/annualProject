...
Class IndividualManager{
    ...
    public function getAll() : array{
        ...
        $json = $api->getByString('Discriminator', 'Individual');

        $result = [];
        foreach($json as $line){
            $siteManager = new SiteManager();
            $site = $siteManager->getById(intval($line['SiteID']));
            $user = new Individual($line['ID'], $line['Email'], $line['Name'], $line['Password'], $line['Numero'], $line['Rue'], $line['Postcode'], $line['Area'], $line['Eligibility'], $line['Surname'], $site);
