<header class = "navbar navbar-expand-sm">
    <ul class = "navbar-nav align-items-center">
        <li class = "nav-item col-md-3 offset-md-1">
            <a href = "#" style = 'text-transform : uppercase' class = 'nav-link'>
        ...
        <a href = "/" class = 'navbar-brand nav-item col-md-1'>
            <img src = 'http://public/images/logo.png' style="width:40px;">
        </a>
        ...
        <li class="nav-item col-md-3">
            <a href = "compteView.php" style = 'text-transform : uppercase' class= 'nav-link'>
                <h5 class = 'menu'>Compte</h5>
            </a>
        </li>
        <li class="nav-item col-md-3">
            <a href = "connexionView.php" style = 'text-transform : uppercase' class= 'nav-link'>
