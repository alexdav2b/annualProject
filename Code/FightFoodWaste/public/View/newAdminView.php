...
<div class = "col-md-6 offset-md-3 col-lg-6 offset-lg-3">
    <h2 class= "col-md-6 offset-md-4 col-lg-6 offset-lg-4">Nouvel Admin</h2>

    <form id = 'Employee' method = "post" action = "/log/admin" onsubmit = 'InsriptionA(this)'>
        <div class = 'row form-group' style = 'margin-bottom : 0 !important; padding-top : 0 !important; padding-left : 15px !important; padding-right : 15px !important;'>
            ...
            <input onblur = 'verifName(this)' required class = "inline col-md-8 col-lg-8 form-control" type = "text" name = 'Name' id = 'NameID' placeholder = "Name">
            ...
            <input  onblur ='verifMail(this)' required pattern="[a-z0-9._%+-]+@[a-z0-9.-]+\.[a-z]{2,4}$" type = "email" class = "inline col-lg-8 col-md-8 form-control" type = "text" name = 'Email' id = 'EmailID' placeholder = "Email@host.fr">
            ...
            <input  onblur = 'verifArea(this)' required class = 'form-control col-md-8 col-lg-8 inline' type = 'text' name = 'Area' id = 'AreaID' placeholder = "Area">
            ...
            <p class = 'col-md-12 inline '>
                ...
                <a href = "/comptes" class = "btn btn-danger col-md-4 offset-md-2 col-lg-4 offset-lg-2" id = "Create">Annuler</a>
            </p>
        </div>
    </form>
