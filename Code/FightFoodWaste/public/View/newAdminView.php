...
<div class = "col-md-6 offset-md-3 col-lg-6 offset-lg-3">
    ...
    <form id = 'Employee' method = "post" action = "/log/admin">
        <div class = 'row form-group' style = 'margin-bottom : 0 !important; padding-top : 0 !important; padding-left : 15px !important; padding-right : 15px !important;'>
            ...
            <input required pattern="[a-z0-9._%+-]+@[a-z0-9.-]+\.[a-z]{2,4}$" type = "email" class = "inline col-lg-8 col-md-8 form-control" type = "text" name = 'Email' id = 'EmailID' placeholder = "Email@host.fr">
            ...
            <input required class = 'form-control col-md-8 col-lg-8 inline' type = 'text' name = 'Area' id = 'AreaID' placeholder = "Area">
